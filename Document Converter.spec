...
hiddenimports = [
    ...
    'src.services.hardware_detector',
    'src.services.model_manager',
    'src.ui_flet.components.youtube_dialog',
    'src.ui_flet.components.batch_dialog',
    'src.ui_flet.components.model_hub_dialog',
    'src.ui_flet.components.first_time_model_dialog',
