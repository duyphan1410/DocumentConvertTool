...
| **PowerPoint Module (`.pptx`)** | `src/modules/pptx_module.py` | Chuyển đổi slide PowerPoint `.pptx` thành ghi chú Markdown và tạo slide từ Markdown (`PPTX ↔ MD`). | ⏳ Planned (v1.6) |
